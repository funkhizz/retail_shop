...
STRIPE_SECRET_KEY = getattr(settings, "STRIPE_SECRET_KEY", "sk_test_KTD8bZQe1jHFF1tLelcTZPgr00PZpIFVwV")
STRIPE_PUB_KEY = getattr(settings, "STRIPE_PUB_KEY", "pk_test_O5HC5E5txvOnI4WBbwPregB400xCMlbyq6")
